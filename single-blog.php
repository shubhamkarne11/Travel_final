...
$query = "SELECT * FROM top_nav,nav,section_control,blog,about,footer,home,single_blog";
...
<body>
   ...
   <div class="slider-area ">
      <!-- Mobile Menu -->
      <div class="single-slider slider-height2 d-flex align-items-center" data-background="images/<?=$user_data['sblog_bg']?>">
          <div class="container">
              <div class="row">
                  <div class="col-xl-12">
            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                     <img class="img-fluid" src="images/<?=$user_data['blog_pic1']?>" alt="">
                  </div>
                  <div class="blog_details">
                     <h2>
                        <?=$user_data['sblog_details']?>
                     </h2>
                  ...
                  <div class="navigation-area">
                     <div class="row">
                        <div
                           ...
                           <div class="thumb">
                              <a href="#">
                                 <img class="img-fluid" src="images/<?=$user_data['sblog_nxbg2']?>" alt="">
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="#">
                        ...
                        <div
                           ...
                           <div class="thumb">
                              <a href="#">
                                 <img class="img-fluid" src="images/<?=$user_data['sblog_nxbg1']?>" alt="">
                              </a>
                           </div>
                        </div>
                     </div>
               ...
               <div class="blog-author">
                  <div class="media align-items-center">
                     <img src="images/<?=$user_data['sblog_cnamepic1']?>" alt="">
                     <div class="media-body">
                        <a href="#">
                           <h4><?=$user_data['sblog_cname1']?></h4>
                        </a>
                        <p> 
                        <?=$user_data['sblog_comment1']?>
                        </p>
                     </div>
                  </div>
               </div>
               <div class="comments-area">
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           <div class="thumb">
                              <img src="images/<?=$user_data['sblog_cnamepic2']?>" alt="">
                           </div>
                           <div class="desc">
                              <p class="comment">
                                  <?=$user_data['sblog_cname2']?>
                              </p>
                              <div class="d-flex justify-content-between">
                                 <div class="d-flex align-items-center">
                                    <h5>
                                       <a href="#"><?=$user_data['sblog_comment2']?></a>
                                    </h5>
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           <div class="thumb">
                              <img src="images/<?=$user_data['sblog_cnamepic3']?>" alt="">
                           </div>
                           <div class="desc">
                              <p class="comment">
                                   <?=$user_data['sblog_cname3']?>
                              </p>
                              <div class="d-flex justify-content-between">
                                 <div class="d-flex align-items-center">
                                    <h5>
                                       <a href="#"><?=$user_data['sblog_comment3']?></a>
                                    </h5>
                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                                 </div>
                                 <div class="reply-btn">
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           <div class="thumb">
                              <img src="images/<?=$user_data['sblog_cnamepic4']?>" alt="">
                           </div>
                           <div class="desc">
                              <p class="comment">
                                   <?=$user_data['sblog_cname4']?>
                              </p>
                              <div class="d-flex justify-content-between">
                                 <div class="d-flex align-items-center">
                                    <h5>
                                       <a href="#"><?=$user_data['sblog_comment4']?></a>
                                    </h5>
                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                                 </div>
                                 <div class="reply-btn">
