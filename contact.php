...
$query = "SELECT * FROM top_nav,nav,section_control,about,package,contact,footer,home";
...
<body>
    ...
    <div class="slider-area ">
        <!-- Mobile Menu -->
        <div class="single-slider slider-height2 d-flex align-items-center" data-background="images/<?=$user_data['contact_bg1']?>">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="send.php" method="post">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3><?=$user_data['contact_address']?></h3>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3><?=$user_data['contact_phone']?></h3>
                                <p><?=$user_data['contact_time']?></p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3><?=$user_data['contact_email']?></h3>
